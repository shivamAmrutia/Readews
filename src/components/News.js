...
export default class News extends Component {
   ...
   async componentDidMount(){
      let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=8df3962a2597424284deb7aa7adf3c14&pageSize=${this.props.page}`;
  ...
  handlePrevClick = async ()=>{
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=8df3962a2597424284deb7aa7adf3c14&page=${this.state.page-1}&pageSize=${this.props.page}`;
